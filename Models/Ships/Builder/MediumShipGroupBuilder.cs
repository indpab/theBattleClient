...
{
    class MediumShipGroupBuilder : IBuilder
    {
        ShipGroup shipGroup;
        /// <summary>
        ...
        public void AddMediumSubmarine(MediumShipFactory mediumShipFactory)
        {
            MediumSubmarine mediumSubmarine = (MediumSubmarine)mediumShipFactory.CreateSubmarine(0, 0, false);
            shipGroup.Ships.Add(mediumSubmarine);
        }
        public void AddMediumDestroyer(MediumShipFactory mediumShipFactory)
        {
